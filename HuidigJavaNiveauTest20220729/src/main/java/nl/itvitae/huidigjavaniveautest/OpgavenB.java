...
class GuessingGame {
    ...
    public static void Guess() {
        ...
        throw new NotYetImplementedException("Implementeer de Guess() methode!");
    }
}
...
class Flower {
    ...
    public static Flower getSeedling() {
        // vul hier de code in
        throw new NotYetImplementedException("Implementeer de GetSeedling() methode!");
    }
    ...
    public void water() {
        ...
        throw new NotYetImplementedException("Implementeer de Water() methode!");
    }
    ...
    public String report() {
        ...
        throw new NotYetImplementedException("Implement the Report() method!");
    }
}
